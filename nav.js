...
<div class="nav">
    <img src="./images/logoimages-removebg-preview.png" class="brand-logo" alt="">
    <div class="nav-items">
        ...
        <div class="login-logout-popup hide">
            <p class="account-info1">welcome,</p>
                ...
                <li class="dd-item"><a href="#" class="link">home</a></li>
                 <li class="dd-item"><a href="seller" class="link">admin-Panel</a></li>
...
<div class="links-container">
    ...
    <li class="link-item"><a href="http://localhost:3050/" class="link">home</a></li>
    <li class="link-item"><a href="#" class="link">About</a>
  
    </li>
    <li class="link-item"><a href="#" class="link">Factions</a>
   
    </li>
    <li class="link-item"><a href="#" class="link">Tokens</a></li>
    <li class="link-item"><a href="#" class="link">Teams</a></li>
...
window.onload = () => {
    ...
    if(user != null){
        ...
        popuptext.innerHTML = 'To access account and manage orders';
